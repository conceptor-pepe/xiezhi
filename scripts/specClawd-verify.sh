...
usage() {
  echo "Usage: scripts/specClawd-verify.sh <change-dir>" >&2
}
...
if [[ -d "$repo_root/docs/specClawd/policies" ]]; then
  require_file_if_present_parent "$repo_root/docs/specClawd/policies/audit-policy.md" "Missing repository audit policy"
  require_file_if_present_parent "$repo_root/docs/specClawd/policies/coding-standards.md" "Missing repository coding standards policy"
  require_file_if_present_parent "$repo_root/docs/specClawd/policies/test-review-policy.md" "Missing repository test review policy"
fi
