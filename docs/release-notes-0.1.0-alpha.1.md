...
This release introduces specClawd as a gate-driven engineering framework for AI-assisted software development. The goal of this alpha is not completeness. The goal is to ship a coherent, installable, reviewable prototype that demonstrates the product direction.
